...
export function MicOutlineIcon({ size = 'normal', color = COLOR.SECONDARY }: MicOutlineIconProps) {
  ...
  return (
    <Svg width={iconSize} height={iconSize} viewBox='0 0 24 24' fill='none'>
      <Path d='M9 21H15' stroke={contentColor} stroke-linecap='round' stroke-linejoin='round' />
      <Path
      ...
      />
      <Path d='M12 17.25V21' stroke={contentColor} stroke-linecap='round' stroke-linejoin='round' />
      <Path
