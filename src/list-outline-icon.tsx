...
export function ListOutlineIcon({
  ...
  return (
    <Svg width={iconSize} height={iconSize} viewBox='0 0 24 24' fill='none'>
      <Path d='M7.5 6.75H21' stroke={contentColor} stroke-linecap='round' stroke-linejoin='round' />
      <Path d='M7.5 12H21' stroke={contentColor} stroke-linecap='round' stroke-linejoin='round' />
      <Path
        d='M7.5 17.25H21'
        stroke={contentColor}
