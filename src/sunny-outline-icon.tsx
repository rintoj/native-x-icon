...
export function SunnyOutlineIcon({
  ...
  return (
    <Svg width={iconSize} height={iconSize} viewBox='0 0 24 24' fill='none'>
      <Path d='M12 2.25V4.5' stroke={contentColor} stroke-miterlimit='10' stroke-linecap='round' />
      <Path
        d='M12 19.5V21.75'
        stroke={contentColor}
      ...
      <Path
        ...
        stroke-linecap='round'
      />
      <Path d='M4.5 12H2.25' stroke={contentColor} stroke-miterlimit='10' stroke-linecap='round' />
      <Path
