  ...
  return (
    <Svg width={iconSize} height={iconSize} viewBox='0 0 24 24' fill='none'>
      ...
      <Path
        ...
        stroke-linejoin='round'
      />
      <Path d='M2.25 9H9' stroke={contentColor} stroke-linecap='round' stroke-linejoin='round' />
      <Path d='M15 9H21.75' stroke={contentColor} stroke-linecap='round' stroke-linejoin='round' />
      <Path
