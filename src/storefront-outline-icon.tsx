...
export function StorefrontOutlineIcon({
  ...
  return (
    <Svg width={iconSize} height={iconSize} viewBox='0 0 24 24' fill='none'>
      <Path d='M21 21V11.25' stroke={contentColor} stroke-linecap='round' stroke-linejoin='round' />
      <Path d='M3 11.25V21' stroke={contentColor} stroke-linecap='round' stroke-linejoin='round' />
      <Path
