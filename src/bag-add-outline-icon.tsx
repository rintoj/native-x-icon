...
export function BagAddOutlineIcon({
  ...
  return (
    <Svg width={iconSize} height={iconSize} viewBox='0 0 24 24' fill='none'>
      <Path d='M12 12V18' stroke={contentColor} strokeLinecap='round' strokeLinejoin='round' />
      <Path d='M15 15H9' stroke={contentColor} strokeLinecap='round' strokeLinejoin='round' />
      <Path
        fillRule='evenodd'
        clipRule='evenodd'
