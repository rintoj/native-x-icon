...
export interface OpenOutlineIconProps {
  color?: string
  size?: IconSize
}

export function OpenOutlineIcon({
  size = 'normal',
  color = COLOR.SECONDARY,
}: OpenOutlineIconProps) {
