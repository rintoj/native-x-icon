  ...
  return (
    <Svg width={iconSize} height={iconSize} viewBox='0 0 24 24' fill='none'>
      ...
      <Path
        ...
        fill={contentColor}
      />
      <Path d='M2.25 9H4.5' stroke={contentColor} stroke-miterlimit='10' stroke-linecap='round' />
      <Path
      ...
      />
      <Path d='M9 2.25V4.5' stroke={contentColor} stroke-miterlimit='10' stroke-linecap='round' />
      <Path
