  ...
  return (
    <Svg width={iconSize} height={iconSize} viewBox='0 0 24 24' fill='none'>
      ...
      <Path
        ...
        strokeLinejoin='round'
      />
      <Path d='M11.25 6H14.25' stroke={contentColor} strokeLinecap='round' strokeLinejoin='round' />
      <Path d='M11.25 9H14.25' stroke={contentColor} strokeLinecap='round' strokeLinejoin='round' />
      <Path d='M5.25 12H14.25' stroke={contentColor} strokeLinecap='round' strokeLinejoin='round' />
      <Path d='M5.25 15H14.25' stroke={contentColor} strokeLinecap='round' strokeLinejoin='round' />
      <Path d='M5.25 18H14.25' stroke={contentColor} strokeLinecap='round' strokeLinejoin='round' />
      <Path
