...
export interface FileTrayFullOutlineIconProps {
  color?: string
  size?: IconSize
}

export function FileTrayFullOutlineIcon({
  size = 'normal',
  color = COLOR.SECONDARY,
}: FileTrayFullOutlineIconProps) {
  ...
  return (
    <Svg width={iconSize} height={iconSize} viewBox='0 0 24 24' fill='none'>
      ...
      <Path
        ...
        stroke-linejoin='round'
      />
      <Path d='M6 9.75H18' stroke={contentColor} stroke-linecap='round' stroke-linejoin='round' />
    </Svg>
  )
}
